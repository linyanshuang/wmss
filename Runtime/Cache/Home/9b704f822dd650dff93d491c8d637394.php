...
<section>
	<div class="span12">
        <form class="login-form" action="/Home/User/register.html" method="post">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="inputMobile" class="span3" placeholder="请输入手机号码"  ajaxurl="/member/checkUserMobileUnique.html" errormsg="请填写正确格式的手机" nullmsg="请填写手机" datatype="e" maxlength='11' value="" name="mobile">
            </div>
          </div>
          <div class="control-group">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="inputCompany" class="span3" placeholder="请输入公司名称"  value="" name="company">
            </div>
          </div>
          <div class="control-group">
            <label class="control-label" for="inputPassword">验证码</label>
            <div class="controls">
              <input type="text" id="inputPassword" autocomplete="off" class="span3" placeholder="请输入验证码"  errormsg="请填写5位验证码" nullmsg="请填写验证码" datatype="*5-5" name="verify">
            </div>
          </div>
          <div class="control-group">
