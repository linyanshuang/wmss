...
<body>
	...
	<!-- 标题栏 -->
		...
		<li class="current"><a href="<?php echo U('updatenickname');?>">修改邮箱</a></li>
		</ul>
    ...
    <form action="<?php echo U('User/submitNickname');?>" method="post" class="form-horizontal" autocomplete="off">
     <input type="hidden" name="uid" value="<?php echo ($uid); ?>" />
		...
		<div class="form-item">
			<label class="item-label">邮箱：<span class="check-tips">（请输入新邮箱）</span></label>
			<div class="controls">
				<input type="text" name="email" class="text input-large" autocomplete="off" value="<?php echo ($email); ?>"/>
			</div>
		</div>
		<div class="form-item">
