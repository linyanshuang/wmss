...
<body>
    ...
    <div>
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('searchlog');?>"><i class="btn-search"></i></a>
			</div>
		</div>
    </div>
	<!-- 数据列表 -->
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo get_keywords_result_count($vo['model']);?></td>
			...
			<td>
				...
				<a class="confirm ajax-get" href="<?php echo U('Action/cleanKeyword?keyword='.$vo['model']);?>">清除缓存</a>
                </td>
