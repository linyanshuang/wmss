...
var __parent0=require('$model/UI2/dlmm/page/message/orderMsgList'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cvmUrAj';
	this._flag_='f7813272a3bbc9040d2918e67f938fae';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"content":{"define":"content","label":"消息","name":"content","relation":"content","type":"String"},"count":{"define":"count","label":"未读消息数","name":"count","relation":"count","type":"String"},"orderid":{"define":"orderid","label":"订单编号","name":"orderid","relation":"orderid","type":"String"},"ordertitle":{"define":"ordertitle","label":"订单标题","name":"ordertitle","relation":"ordertitle","type":"String"},"touaddr":{"define":"touaddr","label":"头像地址","name":"touaddr","relation":"touaddr","type":"String"}},"directDelete":false,"events":{"onCreate":"data1Create","onCustomRefresh":"data1CustomRefresh"},"idColumn":"ordertitle","limit":10,"xid":"data1"});
}}); 
return __result;});
